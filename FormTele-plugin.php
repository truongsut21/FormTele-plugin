...
function tailwind_popup_enqueue_scripts()
{
    ...
    wp_enqueue_script('tailwind-popup-js', plugin_dir_url(__FILE__) . 'handele_send_message.js', array('jquery'), null, true);
}
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow ">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    ...
                    <button type="button" id="btn-close-modal" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-toggle="crud-modal">
                ...
                <form class="p-4 md:p-5" id="modalForm">
                    ...
                    type="submit" class="text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
